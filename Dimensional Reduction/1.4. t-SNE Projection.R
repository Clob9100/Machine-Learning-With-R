...
tsne_result <- Rtsne(data_numeric, dims = 4, perplexity = 20, check_duplicates = FALSE)  # Reduce to 2 dimensions

# Create a data frame for visualization
tsne_df <- data.frame(
  tSNE1 = tsne_result$Y[, 2],  # First t-SNE dimension
  tSNE2 = tsne_result$Y[, 4],  # Second t-SNE dimension
