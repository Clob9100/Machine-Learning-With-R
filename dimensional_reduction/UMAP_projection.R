...
umap_result <- umap(data_numeric, n_components =2)  # Reduce to 4 dimensions


# Create a data frame for visualization
umap_df <- data.frame(
  UMAP1 = umap_result$layout[, 1],  # First UMAP dimension
  UMAP2 = umap_result$layout[, 2],  # Second UMAP dimension
